...
Public Class EditInternal_Invb
    ...
    Public Sub Alert(msg As String, type As frmAlert.alertTypeEnum)
        ...
        'f.ShowDialog()
    End Sub
    Private Sub EditInternal_Invb_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        ...
        ElseIf Guna2CircleProgressBar2.Value = 100 Then
            ...
            End If
            cc.UpdateInInLetter(Guna2TextBox1, CBDatabaseType, Guna2TextBox4, Guna2DateTimePicker1, Guna2DateTimePicker2, Guna2ComboBox3,
                                Guna2ComboBox1, Guna2ComboBox2, Guna2TextBox5, Guna2TextBox3, Guna2TextBox6, Guna2DateTimePicker3, id, FileData)
            cc.UserTrackingININEdit(Module2.Number, Module2.DocID)
