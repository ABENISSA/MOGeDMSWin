...
Public Class EditInternal_Out
    ...
    Public Sub Alert(msg As String, type As frmAlert.alertTypeEnum)
        ...
        'f.ShowDialog()
    End Sub
    Private Sub EditInternal_Out_Load(sender As Object, e As EventArgs) Handles Me.Load
        cc.GetDep(Guna2ComboBox3, "ICT_DEP", "DEP_NAME", "DEP_ID")
    ...
    Sub loadDataToControles()
        ...
        Guna2DateTimePicker2.Value = CDate(dtt.Tables(0).Rows(0)("SENT_DATE").ToString())
        Guna2ComboBox1.Text = dtt.Tables(0).Rows(0)("CAT").ToString()
        Guna2ComboBox2.Text = dtt.Tables(0).Rows(0)("UserName").ToString()
        Guna2ComboBox3.Text = dtt.Tables(0).Rows(0)("SENT_TO").ToString()
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        ...
        ElseIf Guna2CircleProgressBar2.Value = 100 Then
            ...
            End If
            cc.UpdateInOutLetter(Guna2TextBox1, CBDatabaseType, Guna2TextBox4, Guna2DateTimePicker1, Guna2DateTimePicker2, Guna2ComboBox3,
