...
Public Class EditExternal_OUT
    ...
    Public Sub Alert(msg As String, type As frmAlert.alertTypeEnum)
        ...
        'f.ShowDialog()
    End Sub
    Private Sub EditExternal_OUT_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        ...
        ElseIf Guna2CircleProgressBar2.Value = 100 Then
            ...
            End If
            cc.UpdateOutOutLetter(Guna2TextBox1, CBDatabaseType, Guna2TextBox4, Guna2DateTimePicker1, Guna2DateTimePicker2, Guna2ComboBox3,
