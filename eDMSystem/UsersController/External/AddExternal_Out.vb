...
Public Class AddExternal_Out
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        ...
        ElseIf Guna2CircleProgressBar2.Value = 100 Then
            ...
            End If
            cs.InsertOutOutLetter(Guna2TextBox2, CBDatabaseType, Guna2TextBox4, Guna2DateTimePicker1, Guna2DateTimePicker2, Guna2ComboBox3,
    ...
    Private Sub ButtonImport_Click(sender As Object, e As EventArgs) Handles ButtonImport.Click
        ...
        Timer1.Start()
    End Sub
    Private Sub AddExternal_Out_Load(sender As Object, e As EventArgs) Handles Me.Load
        cs.Yaercb(CBDatabaseType, "ICT_YearTable")
        Dim id As Integer = cs.GET_LAST_RECORED("ICT_EXTERNAL_OUTGO", "[DOC_REF]", CStr(CBDatabaseType.SelectedValue), Guna2TextBox2)
        cs.GetDep(Guna2ComboBox3, "ICT_COM", "COM_NAME", "COM_ID")
    End Sub
